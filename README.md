...
- Враги либо стояли на месте, либо двигались некорректно.
...
- Введён класс `Enemy`, в котором прописано базовое поведение и логика движения. Добавлена система обновления состояния и проверки столкновений с героем.
